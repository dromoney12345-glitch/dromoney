...
const inputClass =
    'w-full bg-white text-[#462211] font-medium pl-11 pr-4 py-3 rounded-xl border border-[#E5E7EB] focus:border-[#462211]/40 focus:outline-none transition-all placeholder:text-[#C4B5A8] text-[14px]';
            ...
            {step === 1 ? (
                <form onSubmit={handleSendOtp} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        <label className="flex items-start gap-2.5 cursor-pointer group">
                            <input
                                ...
                                className="mt-0.5 w-4 h-4 rounded border-[#D1D5DB] accent-[#462211] cursor-pointer"
                            />
                            <span className="text-[11px] text-[#7A5648] leading-relaxed group-hover:text-[#462211] transition-colors">
                                I agree to the{' '}
                    ...
                    <button
                        ...
                        className="w-full bg-[#462211] hover:bg-[#5a2d1a] disabled:opacity-50 disabled:pointer-events-none text-white py-3.5 rounded-xl font-medium text-[14px] transition-all active:scale-[0.99] flex items-center justify-center gap-2"
                    >
                    ...
                    <p className="text-center text-[11px] text-[#A89890] pt-1">
                        ...
                        <Link to="/user/auth/register" className="text-[#462211] font-medium underline underline-offset-2">
                            Sign Up
                        </Link>
                    </p>
                </form>
